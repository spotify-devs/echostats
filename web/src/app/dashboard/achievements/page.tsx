...
export default function AchievementsPage() {
  ...
  const _uniqueTracks = data?.unique_tracks || 0;
  ...
  const achievements: Achievement[] = [
    ...
    },
    {
      ...
      icon: Target,
      title: "Genre Master",
      description: "Discover 20 genres",
      threshold: 20,
      current: uniqueGenres,
      unit: "genres",
      color: "#ec4899",
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="glass-card px-4 py-2 text-center">
          <p className="text-2xl font-bold text-accent-dynamic">
      ...
      <div className="w-full h-3 rounded-full bg-theme-surface-3 overflow-hidden">
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(90deg, var(--accent-gradient-from), var(--accent-gradient-via))",
          }}
        />
      </div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-accent-dynamic mt-1">
                    ✓ {a.current.toLocaleString()} {a.unit}
                  </p>
                </div>
              </div>
            ))}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2">
                      <div className="flex justify-between text-[10px] text-theme-tertiary mb-1">
                        <span>
                          {a.current.toLocaleString()} / {a.threshold.toLocaleString()} {a.unit}
                        </span>
                        <span>{Math.round(progress)}%</span>
                      </div>
                      <div className="w-full h-1.5 rounded-full bg-theme-surface-3 overflow-hidden">
                        <div
                          className="h-full rounded-full bg-theme-surface-4 transition-all"
