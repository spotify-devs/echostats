    ...
    <div className="space-y-8 max-w-3xl mx-auto pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="glass-card p-6 text-center space-y-3">
          ...
          {topArtist?.image_url && (
            <div className="relative w-20 h-20 rounded-full overflow-hidden mx-auto ring-2 ring-amber-400/30">
        ...
        <div className="glass-card p-6 text-center space-y-3">
          ...
          {topTrack?.image_url && (
            <div className="relative w-20 h-20 rounded-2xl overflow-hidden mx-auto ring-2 ring-accent-dynamic/30">
